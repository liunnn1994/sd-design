...
For the day-to-day edit-build-lint-test workflow, see [build-and-test-workflow.md](build-and-test-workflow.md).
...
For Node.js core build verbosity (`make V=1`), see [build-and-test-workflow.md](build-and-test-workflow.md#build).
...
For Node.js core linting and formatting, see [build-and-test-workflow.md](build-and-test-workflow.md#lint).
