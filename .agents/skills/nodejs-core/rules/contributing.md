...
For building, linting, and testing, see [build-and-test-workflow.md](build-and-test-workflow.md).
...
For lint and formatting commands, see [build-and-test-workflow.md](build-and-test-workflow.md#lint).
...
For build, test, and workflow commands, see [build-and-test-workflow.md](build-and-test-workflow.md#test).
