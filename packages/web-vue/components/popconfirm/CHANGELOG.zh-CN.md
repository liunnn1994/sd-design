...
- 修复不同类型下图标默认黑色的问题 ([#1366](https://github.com/liunnn1994/sd-design/pull/1366))
...
- 修正组件样式问题，并调整按钮默认大小为 `mini`，同 React 保持一致 ([#390](https://github.com/liunnn1994/sd-design/pull/390))
...
- 修复 `ok/cancel` 按钮参数丢失的问题 ([#105](https://github.com/liunnn1994/sd-design/pull/105))
