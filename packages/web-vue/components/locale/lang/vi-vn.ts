...
const lang: SdLang = {
  ...
  a11y: {
    ...
    breadcrumbEllipsis: 'Thêm mục breadcrumb',
    anchorNav: 'Điều hướng neo',
    ...
    moveSelectedRight: 'Chuyển mục đã chọn sang phải',
    moveSelectedLeft: 'Chuyển mục đã chọn sang trái',
    secretShow: 'Hiển thị thông tin nhạy cảm',
    secretHide: 'Ẩn thông tin nhạy cảm',
    selectColor: 'Chọn màu {0}',
    slideOf: 'Trang chiếu {0} trên {1}',
    goToSlide: 'Đi đến trang chiếu {0}',
