...
const lang: SdLang = {
  ...
  a11y: {
    ...
    breadcrumbEllipsis: 'รายการเบรดครัมบ์เพิ่มเติม',
    anchorNav: 'การนำทางด้วยจุดยึด',
    carousel: 'คารูเซล',
    steps: 'ขั้นตอน',
    verificationCode: 'รหัสยืนยัน',
    rating: 'การให้คะแนน',
    toggleSidebar: 'สลับแถบด้านข้าง',
    filePreview: 'ดูตัวอย่างไฟล์',
    loading: 'กำลังโหลด',
    nextPage: 'หน้าถัดไป',
    ...
    moveSelectedRight: 'ย้ายรายการที่เลือกไปทางขวา',
    moveSelectedLeft: 'ย้ายรายการที่เลือกไปทางซ้าย',
    secretShow: 'แสดงข้อมูลละเอียดอ่อน',
    secretHide: 'ซ่อนข้อมูลละเอียดอ่อน',
    selectColor: 'เลือกสี {0}',
    slideOf: 'สไลด์ {0} จาก {1}',
