...
const lang: SdLang = {
  ...
  a11y: {
    ...
    retryUpload: 'Repetir carregamento',
    increase: 'Aumentar',
    decrease: 'Diminuir',
    ...
    breadcrumbEllipsis: 'Mais itens do caminho de navegação',
    anchorNav: 'Navegação por âncoras',
    carousel: 'Carrossel',
    steps: 'Etapas',
    verificationCode: 'Código de verificação',
    rating: 'Avaliação',
    toggleSidebar: 'Alternar barra lateral',
    filePreview: 'Pré-visualização de ficheiro',
    loading: 'A carregar',
    ...
    secretShow: 'Mostrar informações confidenciais',
    secretHide: 'Ocultar informações confidenciais',
    selectColor: 'Selecionar cor {0}',
    slideOf: 'Diapositivo {0} de {1}',
    goToSlide: 'Ir para o diapositivo {0}',
