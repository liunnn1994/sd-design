...
const lang: SdLang = {
  ...
  a11y: {
    ...
    breadcrumbEllipsis: 'Ещё элементы навигации',
    anchorNav: 'Якорная навигация',
    carousel: 'Карусель',
    steps: 'Шаги',
    ...
    moveSelectedRight: 'Переместить выбранное вправо',
    moveSelectedLeft: 'Переместить выбранное влево',
    secretShow: 'Показать конфиденциальную информацию',
    secretHide: 'Скрыть конфиденциальную информацию',
    selectColor: 'Выбрать цвет {0}',
    slideOf: 'Слайд {0} из {1}',
