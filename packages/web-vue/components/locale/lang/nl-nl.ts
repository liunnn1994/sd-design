...
const lang: SdLang = {
  ...
  a11y: {
    ...
    breadcrumbEllipsis: 'Meer kruimel-items',
    anchorNav: 'Ankernavigatie',
    carousel: 'Carrousel',
    steps: 'Stappen',
    ...
    moveSelectedRight: 'Selectie naar rechts verplaatsen',
    moveSelectedLeft: 'Selectie naar links verplaatsen',
    secretShow: 'Gevoelige informatie tonen',
    secretHide: 'Gevoelige informatie verbergen',
    selectColor: 'Kleur selecteren {0}',
    slideOf: 'Dia {0} van {1}',
