...
const basicDescription = "单选框的基本用法。";
import buttonDemo from '../../.vitepress/theme/generated/radio/button.vue';
...
const buttonDescription = "通过指定 `type=\"button\"` ，可以显示按钮类型的单选框组。";
import controlDemo from '../../.vitepress/theme/generated/radio/control.vue';
...
import customDemo from '../../.vitepress/theme/generated/radio/custom.vue';
...
const customDescription = "使用 #radio 插槽自定义复选框的展示";
import directionDemo from '../../.vitepress/theme/generated/radio/direction.vue';
...
const directionDescription = "通过设置 `direction=\"vertical\"` 可以展示竖直的单选框组。";
import groupDemo from '../../.vitepress/theme/generated/radio/group.vue';
const groupSource = "<template>\n  <a-space direction=\"vertical\" size=\"large\">\n    <a-radio-group>\n      <a-radio value=\"A\">A<\/a-radio>\n      <a-radio value=\"B\">B<\/a-radio>\n      <a-radio value=\"C\">C<\/a-radio>\n      <a-radio value=\"D\">D<\/a-radio>\n    <\/a-radio-group>\n    <a-radio-group>\n      <a-radio value=\"A\">A<\/a-radio>\n      <a-radio value=\"B\">B<\/a-radio>\n      <a-radio value=\"C\">C<\/a-radio>\n      <a-radio value=\"D\" disabled>D<\/a-radio>\n    <\/a-radio-group>\n  <\/a-space>\n<\/template>";
const groupTitle = "Group.Md";
const groupDescription = "通过 `<a-radio-group>` 组件展示单选框组。";
import layoutDemo from '../../.vitepress/theme/generated/radio/layout.vue';
...
const layoutDescription = "使用 `<a-radio-group>` 传入 `<a-radio>`，配合 `<a-grid>` 组件实现灵活的布局。";
import optionsDemo from '../../.vitepress/theme/generated/radio/options.vue';
...
const optionsDescription = "`a-radio-group` 通过 `options` 属性设置子元素";
import sizeDemo from '../../.vitepress/theme/generated/radio/size.vue';
...
const sizeDescription = "按钮类型的单选框组分为 `mini`、`small`、`medium`、`large` 四种尺寸。";
</script>
