...
<script setup lang="ts">
  ...
  const columns = reactive<TableColumnData[]>([
    ...
    { title: 'Data1', dataIndex: 'data1' },
    { title: 'Data2', dataIndex: 'data2' },
  ]);
  const data = reactive<TableData[]>([
    { key: '1', name: 'Jane Doe', salary: 23000, data1: 10, data2: 8, expand: 'Expand Content' },
    { key: '2', name: 'Alisa Ross', salary: 25000, data1: 9, data2: -12 },
    { key: '3', name: 'Kevin Sandra', salary: 22000, data1: 15, data2: -2 },
    { key: '4', name: 'Ed Hellen', salary: 17000, data1: 2, data2: 3 },
    { key: '5', name: 'William Smith', salary: 27000, data1: 11, data2: 0 },
  ]);
  const summary: TableSummary = ({ columns, data }: TableSummaryContext) => {
    ...
    return [
      ...
      { name: 'Sum', salary: countData.salary, data1: countData.data1, data2: countData.data2 },
    ];
  };
