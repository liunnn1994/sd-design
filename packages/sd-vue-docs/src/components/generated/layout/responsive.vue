<template>
  <sd-layout class="layout-responsive-demo">
    <sd-layout-sider
      breakpoint="lg"
      collapsed-width="0"
      theme="dark"
    ...
    >
      <div class="logo" />
      <sd-menu theme="dark" :default-selected-keys="['1']">
        <sd-menu-item key="1">
...
<style scoped>
  ...
  .layout-responsive-demo :deep(.sd-layout-header) {
    height: 64px;
    padding-inline: 48px;
    line-height: 64px;
    color: #fff;
  ...
  .layout-responsive-demo :deep(.sd-layout-content) {
    min-height: 120px;
    line-height: 120px;
    color: #fff;
    text-align: center;
  ...
  .layout-responsive-demo :deep(.sd-layout-footer) {
    color: #fff;
    text-align: center;
    background: #4096ff;
  }
